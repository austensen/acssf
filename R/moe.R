# Copied from tidycensus package by Kyle Walker
# https://github.com/walkerke/tidycensus/blob/master/R/moe.R
...
#'
#' @details Copied from tidycensus package by Kyle Walker https://github.com/walkerke/tidycensus/blob/master/R/moe.R
#'
